...
EXTENSION_ENTRY(dyn_glProgramString,ptr_glProgramString,glProgramString,GLenum -> GLenum -> GLsizei -> Ptr a -> IO ())
EXTENSION_ENTRY(dyn_glBindProgram,ptr_glBindProgram,glBindProgram,GLenum -> GLuint -> IO ())
EXTENSION_ENTRY(dyn_glDeletePrograms,ptr_glDeletePrograms,glDeletePrograms,GLsizei -> Ptr GLuint -> IO ())
EXTENSION_ENTRY(dyn_glGenPrograms,ptr_glGenPrograms,glGenPrograms,GLsizei -> Ptr GLuint -> IO ())
EXTENSION_ENTRY(dyn_glProgramEnvParameter4d,ptr_glProgramEnvParameter4d,glProgramEnvParameter4d,GLenum -> GLuint -> GLdouble -> GLdouble -> GLdouble -> GLdouble  -> IO ())
EXTENSION_ENTRY(dyn_glProgramEnvParameter4dv,ptr_glProgramEnvParameter4dv,glProgramEnvParameter4dv,GLenum -> GLuint -> Ptr GLdouble -> IO ())
EXTENSION_ENTRY(dyn_glProgramEnvParameter4f,ptr_glProgramEnvParameter4f,glProgramEnvParameter4f,GLenum -> GLuint -> GLfloat -> GLfloat -> GLfloat -> GLfloat  -> IO ())
EXTENSION_ENTRY(dyn_glProgramEnvParameter4fv,ptr_glProgramEnvParameter4fv,glProgramEnvParameter4fv,GLenum -> GLuint -> Ptr GLfloat -> IO ())
EXTENSION_ENTRY(dyn_glProgramLocalParameter4d,ptr_glProgramLocalParameter4d,glProgramLocalParameter4d,GLenum -> GLuint -> GLdouble -> GLdouble -> GLdouble -> GLdouble  -> IO ())
EXTENSION_ENTRY(dyn_glProgramLocalParameter4dv,ptr_glProgramLocalParameter4dv,glProgramLocalParameter4dv,GLenum -> GLuint -> Ptr GLdouble -> IO ())
EXTENSION_ENTRY(dyn_glProgramLocalParameter4f,ptr_glProgramLocalParameter4f,glProgramLocalParameter4f,GLenum -> GLuint -> GLfloat -> GLfloat -> GLfloat -> GLfloat  -> IO ())
EXTENSION_ENTRY(dyn_glProgramLocalParameter4fv,ptr_glProgramLocalParameter4fv,glProgramLocalParameter4fv,GLenum -> GLuint -> Ptr GLfloat -> IO ())
EXTENSION_ENTRY(dyn_glGetProgramEnvParameterdv,ptr_glGetProgramEnvParameterdv,glGetProgramEnvParameterdv,GLenum -> GLuint -> Ptr GLdouble -> IO ())
EXTENSION_ENTRY(dyn_glGetProgramEnvParameterfv,ptr_glGetProgramEnvParameterfv,glGetProgramEnvParameterfv,GLenum -> GLuint -> Ptr GLfloat -> IO ())
EXTENSION_ENTRY(dyn_glGetProgramLocalParameterdv,ptr_glGetProgramLocalParameterdv,glGetProgramLocalParameterdv,GLenum -> GLuint -> Ptr GLdouble -> IO ())
EXTENSION_ENTRY(dyn_glGetProgramLocalParameterfv,ptr_glGetProgramLocalParameterfv,glGetProgramLocalParameterfv,GLenum -> GLuint -> Ptr GLfloat -> IO ())
EXTENSION_ENTRY(dyn_glGetProgramString,ptr_glGetProgramString,glGetProgramString,GLenum -> GLenum -> Ptr a -> IO ())
