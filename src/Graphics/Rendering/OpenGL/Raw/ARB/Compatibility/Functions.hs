...
EXTENSION_ENTRY(glPixelMapfv,GLenum -> GLint -> Ptr GLfloat -> IO ())
EXTENSION_ENTRY(glPixelMapuiv,GLenum -> GLint -> Ptr GLuint -> IO ())
EXTENSION_ENTRY(glPixelMapusv,GLenum -> GLint -> Ptr GLushort -> IO ())
