...
EXTENSION_ENTRY(dyn_glTexImage2DMultisample,ptr_glTexImage2DMultisample,"glTexImage2DMultisample",glTexImage2DMultisample,GLenum -> GLsizei -> GLint -> GLsizei -> GLsizei -> GLboolean -> IO ())
EXTENSION_ENTRY(dyn_glTexImage3DMultisample,ptr_glTexImage3DMultisample,"glTexImage3DMultisample",glTexImage3DMultisample,GLenum -> GLsizei -> GLint -> GLsizei -> GLsizei -> GLsizei -> GLboolean -> IO ())
EXTENSION_ENTRY(dyn_glGetMultisamplefv,ptr_glGetMultisamplefv,"glGetMultisamplefv",glGetMultisamplefv,GLenum -> GLuint -> Ptr GLfloat -> IO ())
EXTENSION_ENTRY(dyn_glSampleMaski,ptr_glSampleMaski,"glSampleMaski",glSampleMaski,GLuint -> GLbitfield -> IO ())
