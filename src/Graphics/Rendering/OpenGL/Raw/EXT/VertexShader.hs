...
EXTENSION_ENTRY(glSetInvariant,GLuint -> GLenum -> Ptr a -> IO ())
EXTENSION_ENTRY(glSetLocalConstant,GLuint -> GLenum -> Ptr a -> IO ())
...
EXTENSION_ENTRY(glVariantPointer,GLuint -> GLenum -> GLuint -> Ptr a -> IO ())
