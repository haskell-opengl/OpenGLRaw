...
EXTENSION_ENTRY(dyn_glBeginVertexShader,ptr_glBeginVertexShader,glBeginVertexShader,IO ())
EXTENSION_ENTRY(dyn_glEndVertexShader,ptr_glEndVertexShader,glEndVertexShader,IO ())
EXTENSION_ENTRY(dyn_glBindVertexShader,ptr_glBindVertexShader,glBindVertexShader,GLuint -> IO ())
EXTENSION_ENTRY(dyn_glGenVertexShaders,ptr_glGenVertexShaders,glGenVertexShaders,GLuint -> IO GLuint)
EXTENSION_ENTRY(dyn_glDeleteVertexShader,ptr_glDeleteVertexShader,glDeleteVertexShader,GLuint -> IO ())
EXTENSION_ENTRY(dyn_glShaderOp1,ptr_glShaderOp1,glShaderOp1,GLenum -> GLuint -> GLuint -> IO ())
EXTENSION_ENTRY(dyn_glShaderOp2,ptr_glShaderOp2,glShaderOp2,GLenum -> GLuint -> GLuint -> GLuint -> IO ())
EXTENSION_ENTRY(dyn_glShaderOp3,ptr_glShaderOp3,glShaderOp3,GLenum -> GLuint -> GLuint -> GLuint -> GLuint -> IO ())
EXTENSION_ENTRY(dyn_glSwizzle,ptr_glSwizzle,glSwizzle,GLuint -> GLuint -> GLenum -> GLenum -> GLenum -> GLenum -> IO ())
EXTENSION_ENTRY(dyn_glWriteMask,ptr_glWriteMask,glWriteMask,GLuint -> GLuint -> GLenum -> GLenum -> GLenum -> GLenum -> IO ())
EXTENSION_ENTRY(dyn_glInsertComponent,ptr_glInsertComponent,glInsertComponent,GLuint -> GLuint -> GLuint -> IO ())
EXTENSION_ENTRY(dyn_glExtractComponent,ptr_glExtractComponent,glExtractComponent,GLuint -> GLuint -> GLuint -> IO ())
EXTENSION_ENTRY(dyn_glGenSymbols,ptr_glGenSymbols,glGenSymbols,GLenum -> GLenum -> GLenum -> GLuint -> IO GLuint)
EXTENSION_ENTRY(dyn_glSetInvariant,ptr_glSetInvariant,glSetInvariant,GLuint -> GLenum -> Ptr a -> IO ())
EXTENSION_ENTRY(dyn_glSetLocalConstant,ptr_glSetLocalConstant,glSetLocalConstant,GLuint -> GLenum -> Ptr a -> IO ())
EXTENSION_ENTRY(dyn_glVariantbv,ptr_glVariantbv,glVariantbv,GLuint -> Ptr GLbyte -> IO ())
EXTENSION_ENTRY(dyn_glVariantsv,ptr_glVariantsv,glVariantsv,GLuint -> Ptr GLshort -> IO ())
EXTENSION_ENTRY(dyn_glVariantiv,ptr_glVariantiv,glVariantiv,GLuint -> Ptr GLint -> IO ())
EXTENSION_ENTRY(dyn_glVariantfv,ptr_glVariantfv,glVariantfv,GLuint -> Ptr GLfloat -> IO ())
EXTENSION_ENTRY(dyn_glVariantdv,ptr_glVariantdv,glVariantdv,GLuint -> Ptr GLdouble -> IO ())
EXTENSION_ENTRY(dyn_glVariantubv,ptr_glVariantubv,glVariantubv,GLuint -> Ptr GLubyte -> IO ())
EXTENSION_ENTRY(dyn_glVariantusv,ptr_glVariantusv,glVariantusv,GLuint -> Ptr GLushort -> IO ())
EXTENSION_ENTRY(dyn_glVariantuiv,ptr_glVariantuiv,glVariantuiv,GLuint -> Ptr GLuint -> IO ())
EXTENSION_ENTRY(dyn_glVariantPointer,ptr_glVariantPointer,glVariantPointer,GLuint -> GLenum -> GLuint -> Ptr a -> IO ())
EXTENSION_ENTRY(dyn_glEnableVariantClientState,ptr_glEnableVariantClientState,glEnableVariantClientState,GLuint-> IO ())
EXTENSION_ENTRY(dyn_glDisableVariantClientState,ptr_glDisableVariantClientState,glDisableVariantClientState,GLuint-> IO ())
EXTENSION_ENTRY(dyn_glBindLightParameter,ptr_glBindLightParameter,glBindLightParameter,GLenum -> GLenum-> IO GLuint)
EXTENSION_ENTRY(dyn_glBindMaterialParameter,ptr_glBindMaterialParameter,glBindMaterialParameter,GLenum -> GLenum-> IO GLuint)
EXTENSION_ENTRY(dyn_glBindTexGenParameter,ptr_glBindTexGenParameter,glBindTexGenParameter,GLenum -> GLenum -> GLenum-> IO GLuint)
EXTENSION_ENTRY(dyn_glBindTextureUnitParameter,ptr_glBindTextureUnitParameter,glBindTextureUnitParameter,GLenum -> GLenum-> IO GLuint)
EXTENSION_ENTRY(dyn_glBindParameter,ptr_glBindParameter,glBindParameter,GLenum -> IO GLuint)
EXTENSION_ENTRY(dyn_glIsVariantEnabled,ptr_glIsVariantEnabled,glIsVariantEnabled,GLuint -> GLenum -> IO GLboolean)
EXTENSION_ENTRY(dyn_glGetVariantBooleanv,ptr_glGetVariantBooleanv,glGetVariantBooleanv,GLuint -> GLenum -> Ptr GLboolean -> IO ())
EXTENSION_ENTRY(dyn_glGetVariantIntegerv,ptr_glGetVariantIntegerv,glGetVariantIntegerv,GLuint -> GLenum -> Ptr GLint -> IO ())
EXTENSION_ENTRY(dyn_glGetVariantFloatv,ptr_glGetVariantFloatv,glGetVariantFloatv,GLuint -> GLenum -> Ptr GLfloat -> IO ())
EXTENSION_ENTRY(dyn_glGetVariantPointerv,ptr_glGetVariantPointerv,glGetVariantPointerv,GLuint -> GLenum -> Ptr (Ptr a) -> IO ())
EXTENSION_ENTRY(dyn_glGetInvariantBooleanv,ptr_glGetInvariantBooleanv,glGetInvariantBooleanv,GLuint -> GLenum -> Ptr GLboolean -> IO ())
EXTENSION_ENTRY(dyn_glGetInvariantIntegerv,ptr_glGetInvariantIntegerv,glGetInvariantIntegerv,GLuint -> GLenum -> Ptr GLint -> IO ())
EXTENSION_ENTRY(dyn_glGetInvariantFloatv,ptr_glGetInvariantFloatv,glGetInvariantFloatv,GLuint -> GLenum -> Ptr GLfloat -> IO ())
EXTENSION_ENTRY(dyn_glGetLocalConstantBooleanv,ptr_glGetLocalConstantBooleanv,glGetLocalConstantBooleanv,GLuint -> GLenum -> Ptr GLboolean -> IO ())
EXTENSION_ENTRY(dyn_glGetLocalConstantIntegerv,ptr_glGetLocalConstantIntegerv,glGetLocalConstantIntegerv,GLuint -> GLenum -> Ptr GLint -> IO ())
EXTENSION_ENTRY(dyn_glGetLocalConstantFloatv,ptr_glGetLocalConstantFloatv,glGetLocalConstantFloatv,GLuint -> GLenum -> Ptr GLfloat -> IO ())
