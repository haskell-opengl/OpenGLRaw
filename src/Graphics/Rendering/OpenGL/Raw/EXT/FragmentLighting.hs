...
EXTENSION_ENTRY(dyn_glFragmentLightModeli,ptr_glFragmentLightModeli,glFragmentLightModeli,GLenum -> GLint -> IO ())
EXTENSION_ENTRY(dyn_glFragmentLightModelf,ptr_glFragmentLightModelf,glFragmentLightModelf,GLenum -> GLfloat -> IO ())
EXTENSION_ENTRY(dyn_glFragmentLightModeliv,ptr_glFragmentLightModeliv,glFragmentLightModeliv,GLenum -> Ptr GLint -> IO ())
EXTENSION_ENTRY(dyn_glFragmentLightModelfv,ptr_glFragmentLightModelfv,glFragmentLightModelfv,GLenum -> Ptr GLfloat -> IO ())
EXTENSION_ENTRY(dyn_glFragmentLighti,ptr_glFragmentLighti,glFragmentLighti,GLenum -> GLenum -> GLint -> IO ())
EXTENSION_ENTRY(dyn_glFragmentLightf,ptr_glFragmentLightf,glFragmentLightf,GLenum -> GLenum -> GLfloat -> IO ())
EXTENSION_ENTRY(dyn_glFragmentLightiv,ptr_glFragmentLightiv,glFragmentLightiv,GLenum -> GLenum -> Ptr GLint -> IO ())
EXTENSION_ENTRY(dyn_glFragmentLightfv,ptr_glFragmentLightfv,glFragmentLightfv,GLenum -> GLenum -> Ptr GLfloat -> IO ())
EXTENSION_ENTRY(dyn_glGetFragmentLightiv,ptr_glGetFragmentLightiv,glGetFragmentLightiv,GLenum -> GLenum -> Ptr GLint -> IO ())
EXTENSION_ENTRY(dyn_glGetFragmentLightfv,ptr_glGetFragmentLightfv,glGetFragmentLightfv,GLenum -> GLenum -> Ptr GLfloat -> IO ())
EXTENSION_ENTRY(dyn_glFragmentMaterialf,ptr_glFragmentMaterialf,glFragmentMaterialf,GLenum -> GLenum -> GLfloat -> IO ())
EXTENSION_ENTRY(dyn_glFragmentMateriali,ptr_glFragmentMateriali,glFragmentMateriali,GLenum -> GLenum -> GLint -> IO ())
EXTENSION_ENTRY(dyn_glFragmentMaterialfv,ptr_glFragmentMaterialfv,glFragmentMaterialfv,GLenum -> GLenum -> Ptr GLfloat -> IO ())
EXTENSION_ENTRY(dyn_glFragmentMaterialiv,ptr_glFragmentMaterialiv,glFragmentMaterialiv,GLenum -> GLenum -> Ptr GLint -> IO ())
EXTENSION_ENTRY(dyn_glFragmentColorMaterial,ptr_glFragmentColorMaterial,glFragmentColorMaterial,GLenum -> GLenum -> IO ())
EXTENSION_ENTRY(dyn_glGetFragmentMaterialfv,ptr_glGetFragmentMaterialfv,glGetFragmentMaterialfv,GLenum -> GLenum -> Ptr GLfloat -> IO ())
EXTENSION_ENTRY(dyn_glGetFragmentMaterialiv,ptr_glGetFragmentMaterialiv,glGetFragmentMaterialiv,GLenum -> GLenum -> Ptr GLint -> IO ())
EXTENSION_ENTRY(dyn_glLightEnvi,ptr_glLightEnvi,glLightEnvi,GLenum -> GLint -> IO ())
